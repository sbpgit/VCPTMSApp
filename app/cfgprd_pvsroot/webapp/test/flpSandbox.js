		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Variant-Acccess Nodes",
									"targetURL": "#ProductVariantAcccessNodes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProductVariantAcccessNodes-display": {
								"semanticObject": "ProductVariantAcccessNodes",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cfgapp.pvsroot.cfgprdpvsroot",
									"url": sap.ui.require.toUrl("cfgapp/pvsroot/cfgprdpvsroot")
								}
							}
						}
					}
