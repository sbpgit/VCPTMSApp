sap.ui.define([
        ...
        return BaseController.extend("cpappf.cpassignnodes.controller.Details", {
    
            onInit: function () {
                that = this;
                // DetailHome = this;
                this.bus = sap.ui.getCore().getEventBus();
                this.bus.subscribe("cpappf.cpassignnodes", "addBeginPage", this.addBeginPage, this);
                this.bus.subscribe("cpappf.cpassignnodes", "addDetailPage", this.addDetailPage, this);
            ...
            onExit: function () {
                this.bus.unsubscribe("cpappf.cpassignnodes", "addBeginPage", this.addBeginPage, this);
                this.bus.unsubscribe("cpappf.cpassignnodes", "addDetailPage", this.addDetailPage, this);
                ...
                if (aPages.length < 1) {
                    this.getOwnerComponent().runAsOwner(function () {
                        this.masterView = sap.ui.view({
                            viewName: "cpappf.cpassignnodes.view.ItemMaster",
                            type: "XML"
                        });
