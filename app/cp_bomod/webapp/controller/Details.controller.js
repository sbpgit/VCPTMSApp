sap.ui.define([
	...
	return BaseController.extend("cp.appf.cpbomod.controller.Details", {
		...
		onInit : function () {
			...
			this.bus.subscribe("cp.appf.cpbomod", "addBeginPage", this.addBeginPage, this);
			this.bus.subscribe("cp.appf.cpbomod", "addDetailPage", this.addDetailPage, this);
		...
		onExit: function () {
			this.bus.unsubscribe("cp.appf.cpbomod", "addBeginPage", this.addBeginPage, this);
			this.bus.unsubscribe("cp.appf.cpbomod", "addDetailPage", this.addDetailPage, this);
			...
			if (aPages.length < 1) {
				this.getOwnerComponent().runAsOwner(function () {
					this.masterView = sap.ui.view({
						viewName: "cp.appf.cpbomod.view.ItemMaster",
						type: "XML"
					});
