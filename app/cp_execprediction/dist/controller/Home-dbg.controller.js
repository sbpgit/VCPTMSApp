        ...
        "cp.execpred.cpexecprediction.controller.Home",
        {
          ...
          onRunSend: function () {
            ...
            if (this.oObjDep.getTokens().length > 0 && this.oVer.getValue() && this.oScen.getValue() ) {
               ...
               var finalList = {
                    name: "generatePredictions12",
                    dscription:"Generate Machine Learning Models",
                    action: "%2Fpal%2FgenPredictions",
                    active:true,
                    httpMethod: "POST",
                    startTime:"2022-04-22 14:00 +0000",
                    endTime :"2022-04-23 14:00+0000",
                    schedules:[
                        {
