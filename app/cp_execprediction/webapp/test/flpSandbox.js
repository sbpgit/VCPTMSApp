		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#RunPredictions-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RunPredictions-display": {
								"semanticObject": "RunPredictions",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cp.execpred.cpexecprediction",
									"url": sap.ui.require.toUrl("cp/execpred/cpexecprediction")
								}
							}
						}
					}
