		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Run prediction profiles",
									"targetURL": "#Runpredictionprofiles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Runpredictionprofiles-display": {
								"semanticObject": "Runpredictionprofiles",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cp.runprofiles.cpexeprofiles",
									"url": sap.ui.require.toUrl("cp/runprofiles/cpexeprofiles")
								}
							}
						}
					}
