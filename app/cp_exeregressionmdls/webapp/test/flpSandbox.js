		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#RunRegressionModels-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RunRegressionModels-display": {
								"semanticObject": "RunRegressionModels",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cp.exereg.cpexeregressionmdls",
									"url": sap.ui.require.toUrl("cp/exereg/cpexeregressionmdls")
								}
							}
						}
					}
