sap.ui.define(
    [
      "cp/app/cpgeneratetimesheet/controller/BaseController",
      "sap/m/MessageToast",
      "sap/m/MessageBox",
    ...
    function (
      ...
      return BaseController.extend("cp.app.cpgeneratetimesheet.controller.Home", {
        onInit: function () {
            that = this;
            ...
            this._valueHelpDialogLoc = sap.ui.xmlfragment(
                "cp.app.cpgeneratetimesheet.view.LocDialog",
                this
            );
            ...
            this._valueHelpDialogProd = sap.ui.xmlfragment(
                "cp.app.cpgeneratetimesheet.view.ProdDialog",
                this
            );
            ...
            _onPatternMatched: function () {
              ...
              handleSelection: function (oEvent) {
                ...
                if (sId.includes("Loc")) {
                  ...
                  that.byId("idTile1").setValueColor("Good");
                  that.byId("idTile2").setValueColor("Good");
                  } 
                } 
