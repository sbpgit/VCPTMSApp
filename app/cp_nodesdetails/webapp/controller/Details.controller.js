...
*/
            onInit: function () {
                ...
                this.bus.subscribe("cpappf.cpnodesdetails", "addBeginPage", this.addBeginPage, this);
                this.bus.subscribe("cpappf.cpnodesdetails", "addDetailPage", this.addDetailPage, this);
            ...
            onExit: function () {
                this.bus.unsubscribe("cpappf.cpnodesdetails", "addBeginPage", this.addBeginPage, this);
                this.bus.unsubscribe("cpappf.cpnodesdetails", "addDetailPage", this.addDetailPage, this);
                ...
                if (aPages.length < 1) {
                    this.getOwnerComponent().runAsOwner(function () {
                        this.masterView = sap.ui.view({
                            viewName: "cpappf.cpnodesdetails.view.ItemMaster",
                            type: "XML"
                        });
