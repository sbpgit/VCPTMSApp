sap.ui.define([
	...
	return BaseController.extend("cp.appf.cpprodconfig.controller.Details", {

		onInit: function () {
			that = this;
			// DetailHome = this;
			this.bus = sap.ui.getCore().getEventBus();
			this.bus.subscribe("cp.appf.cpprodconfig", "addBeginPage", this.addBeginPage, this);
			this.bus.subscribe("cp.appf.cpprodconfig", "addDetailPage", this.addDetailPage, this);
		...
		onExit: function () {
			this.bus.unsubscribe("cp.appf.cpprodconfig", "addBeginPage", this.addBeginPage, this);
			this.bus.unsubscribe("cp.appf.cpprodconfig", "addDetailPage", this.addDetailPage, this);
			...
			if (aPages.length < 1) {
				this.getOwnerComponent().runAsOwner(function () {
					this.masterView = sap.ui.view({
						viewName: "cp.appf.cpprodconfig.view.ItemMaster",
						type: "XML"
					});
