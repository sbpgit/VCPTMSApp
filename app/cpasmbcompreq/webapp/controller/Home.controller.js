sap.ui.define(
    [
        ...
        "cpapp/cpasmbcompreq/controller/BaseController",
        ...
        return BaseController.extend("cpapp.cpasmbcompreq.controller.Home", {
            ...
            onInit: function () {
                ...
                if (!this._valueHelpDialogLoc) {
                    this._valueHelpDialogLoc = sap.ui.xmlfragment(
                        "cpapp.cpasmbcompreq.view.LocDialog",
                        this
                    );
                ...
                if (!this._valueHelpDialogVer) {
                    this._valueHelpDialogVer = sap.ui.xmlfragment(
                        "cpapp.cpasmbcompreq.view.VersionDialog",
                        this
                    );
                ...
                if (!this._valueHelpDialogScen) {
                    this._valueHelpDialogScen = sap.ui.xmlfragment(
                        "cpapp.cpasmbcompreq.view.ScenarioDialog",
                        this
                    );
                ...
                if (!this._valueHelpDialogComp) {
                    this._valueHelpDialogComp = sap.ui.xmlfragment(
                        "cpapp.cpasmbcompreq.view.ComponentDialog",
                        this
                    );
            ...
            TableGenerate: function () {
                ...
                that.oTable.bindColumns("/columns", function (sId, oContext) {
                    ...
                    if (columnName === "DemandLocation" || columnName === "Component") {
