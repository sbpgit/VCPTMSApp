		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ComponentRequirements-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ComponentRequirements-display": {
								"semanticObject": "ComponentRequirements",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cpapp.cpasmbcompreq",
									"url": sap.ui.require.toUrl("cpapp/cpasmbcompreq")
								}
							}
						}
					}
