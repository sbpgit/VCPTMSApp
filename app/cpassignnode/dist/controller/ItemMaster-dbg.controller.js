sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend(
      "cpapp.cpassignnode.controller.ItemMaster",
      {
        onInit: function () {
          that = this;
          ...
          if (!this._valueHelpDialogLoc) {
            this._valueHelpDialogLoc = sap.ui.xmlfragment(
              "cpapp.cpassignnode.view.LocDialog",
              this
            );
          ...
          if (!this._valueHelpDialogProd) {
            this._valueHelpDialogProd = sap.ui.xmlfragment(
              "cpapp.cpassignnode.view.ProdDialog",
              this
            );
          ...
          if (!this._oAccesNode) {
            this._oAccesNode = sap.ui.xmlfragment(
              "cpapp.cpassignnode.view.AccesNodes",
              that
            );
          ...
          if (!this._oAccesNodeList) {
            this._oAccesNodeList = sap.ui.xmlfragment(
              "cpapp.cpassignnode.view.AccessNodesList",
              that
            );
