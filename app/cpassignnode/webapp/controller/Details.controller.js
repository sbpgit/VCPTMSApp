sap.ui.define([
        "cpapp/cpassignnode/controller/BaseController",
        ...
        return BaseController.extend("cpapp.cpassignnode.controller.Details", {
    
            onInit: function () {
                that = this;
                // DetailHome = this;
                this.bus = sap.ui.getCore().getEventBus();
                this.bus.subscribe("cpapp.cpassignnode", "addBeginPage", this.addBeginPage, this);
                this.bus.subscribe("cpapp.cpassignnode", "addDetailPage", this.addDetailPage, this);
                ...
                this.getRouter().getRoute("Details").attachPatternMatched(this._onPatternMatched.bind(this));
            ...
            onExit: function () {
                this.bus.unsubscribe("cpapp.cpassignnode", "addBeginPage", this.addBeginPage, this);
                this.bus.unsubscribe("cpapp.cpassignnode", "addDetailPage", this.addDetailPage, this);
                ...
                if (aPages.length < 1) {
                    this.getOwnerComponent().runAsOwner(function () {
                        this.detailView = sap.ui.view({
                            viewName: "cpapp.cpassignnode.view.ItemDetail",
                            type: "XML"
                        });
                ...
                if (aPages.length < 1) {
                    this.getOwnerComponent().runAsOwner(function () {
                        this.masterView = sap.ui.view({
                            viewName: "cpapp.cpassignnode.view.ItemMaster",
                            type: "XML"
                        });
