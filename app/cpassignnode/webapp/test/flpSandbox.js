		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ProductVariantStructure-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProductVariantStructure-display": {
								"semanticObject": "ProductVariantStructure",
								"action": "display",
								"description": "Product Variant Structure",
								"title": "Product Variant Structure",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cpapp.cpassignnode",
									"url": sap.ui.require.toUrl("cpapp/cpassignnode")
								}
							}
						}
					}
