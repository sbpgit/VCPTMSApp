sap.ui.define([
        ...
        return BaseController.extend("cpapp.cpbompvs.controller.Details", {
    
            onInit: function () {
                that = this;
                // DetailHome = this;
                this.bus = sap.ui.getCore().getEventBus();
                this.bus.subscribe("cpapp.cpbompvs", "addBeginPage", this.addBeginPage, this);
                this.bus.subscribe("cpapp.cpbompvs", "addDetailPage", this.addDetailPage, this);
            ...
            onExit: function () {
                this.bus.unsubscribe("cpapp.cpbompvs", "addBeginPage", this.addBeginPage, this);
                this.bus.unsubscribe("cpapp.cpbompvs", "addDetailPage", this.addDetailPage, this);
                ...
                if (aPages.length < 1) {
                    this.getOwnerComponent().runAsOwner(function () {
                        this.masterView = sap.ui.view({
                            viewName: "cpapp.cpbompvs.view.ItemMaster",
                            type: "XML"
                        });
