...
sap.ui.define([
    ...
    return BaseController.extend("cpapp.cpjobscheduler.controller.CreateJob", {
		/**
		 * Called when the Creste Job controller is instantiated.
		 * @public
		 */
        onInit: function () {
            that = this;
...
*/
        onAfterRendering: function () {
            ...
            // Checking for the update or new schedule 
...
*/
        onJobSelect: function (oEvent) {
            var oSelJob;
            // Checking for the schedule update or create new schedule 
       ...
       */
        handleSelection: function (oEvent) {
            ...
            if (sId.includes("Loc")) {
                ...
                // Calling function to get the Products
                that.getProducts();
...
*/
        onScheduleUpdate: function () {
            ...
            // Based on the Job type and schedule type setting data into the inputs
        ...
        */
        IBPjobUpdate: function () {
            ...
            if (that.byId("idJobType").getSelectedKey() === "I" && that.byId("idIBPselect").getSelectedKey() === "E") {
        ...
        /** 
        * This function called to select the import or export for IBP Integration.
        * @param {object} oEvent -the event information.
        */
...
*/
        ...
        */
        onIbpJobImport: function () {
            ...
            this.oGModel.setProperty("/JobDdesc", that.byId("idJobType").getSelectedItem().getText() + " " + "-" + " " + rRadioBtn);
...
*/
        onSdiIntegration: function () {
            ...
            this.oGModel.setProperty("/JobDdesc", that.byId("idJobType").getSelectedItem().getText() + " " + oSelKey);
