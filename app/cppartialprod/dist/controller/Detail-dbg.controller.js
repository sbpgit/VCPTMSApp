sap.ui.define(
    [
      ...
      "cpapp/cppartialprod/controller/BaseController",
    ...
    function (
      ...
      "use strict";
      var oGModel, that;
      return BaseController.extend("cpapp.cppartialprod.controller.Detail", {
       /** 
        ...
        onInit: function () {
          ...
          if (!this._valueHelpDialogLoc) {
            this._valueHelpDialogLoc = sap.ui.xmlfragment(
              "cpapp.cppartialprod.view.LocDialog",
              this
            );
          ...
          if (!this._valueHelpDialogProd) {
            this._valueHelpDialogProd = sap.ui.xmlfragment(
              "cpapp.cppartialprod.view.ProdDialog",
              this
            );
          ...
          if (!this._valueHelpDialogclassName) {
            this._valueHelpDialogclassName = sap.ui.xmlfragment(
              "cpapp.cppartialprod.view.className",
              this
            );
          ...
          if (!this._valueHelpDialogcharName) {
            this._valueHelpDialogcharName = sap.ui.xmlfragment(
              "cpapp.cppartialprod.view.charName",
              this
            );
          ...
          if (!this._valueHelpDialogcharValue) {
            this._valueHelpDialogcharValue = sap.ui.xmlfragment(
              "cpapp.cppartialprod.view.charValue",
              this
            );
