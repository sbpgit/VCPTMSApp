...
function getManifestRoot(root, ui5Version) {
    ...
    return (0, path_1.join)(root, 'section', subFolder);
}
...
function generateCustomSection(basePath, customSection, fs) {
    ...
    if (completeSection.eventHandler) {
        const controllerPath = (0, path_1.join)(completeSection.path, `${completeSection.name}.js`);
        if (!fs.exists(controllerPath)) {
            fs.copyTpl((0, path_1.join)(root, 'common/EventHandler.js'), controllerPath, completeSection);
        }
    }
