sap.ui.define([
    ...
    return BaseController.extend("cpapp.cprestrictions.controller.Details", {
...
*/
        onInit: function () {
            ...
            this.bus.subscribe("cpapp.cprestrictions", "addBeginPage", this.addBeginPage, this);
            this.bus.subscribe("cpapp.cprestrictions", "addDetailPage", this.addDetailPage, this);
        ...
        onExit: function () {
            this.bus.unsubscribe("cpapp.cprestrictions", "addBeginPage", this.addBeginPage, this);
            this.bus.unsubscribe("cpapp.cprestrictions", "addDetailPage", this.addDetailPage, this);
            ...
            if (aPages.length < 1) {
                this.getOwnerComponent().runAsOwner(function () {
                    this.masterView = sap.ui.view({
                        viewName: "cpapp.cprestrictions.view.ItemMaster",
                        type: "XML"
                    });
