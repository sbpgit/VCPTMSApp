...
function getManifestRoot(ui5Version) {
    if (ui5Version === undefined || ui5Version >= 1.86) {
        return (0, path_1.join)(__dirname, '../../templates/column/1.86');
    }
    else if (ui5Version === 1.85) {
        return (0, path_1.join)(__dirname, '../../templates/column/1.85');
    }
    else {
        return (0, path_1.join)(__dirname, '../../templates/column/1.84');
    }
}
...
function generateCustomColumn(basePath, customColumn, fs) {
    (0, validate_1.validateVersion)(customColumn.ui5Version);
    if (!fs) {
    ...
    if (completeColumn.eventHandler) {
        fs.copyTpl((0, path_1.join)(root, 'common/EventHandler.js'), (0, path_1.join)(completeColumn.path, `${completeColumn.name}.js`), completeColumn);
    }
