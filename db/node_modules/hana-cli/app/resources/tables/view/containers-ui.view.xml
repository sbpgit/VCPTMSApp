<mvc:View controllerName="sap.hanacli.tables.controller.containers-ui" height="100%" width="100%"
	...
	<ScrollContainer height="100%" width="100%" vertical="true" focusable="true">
		<f:SimpleForm id="SimpleFormToolbar" editable="true" layout="ResponsiveGridLayout" adjustLabelSpan="true" singleContainerFullSize="false" ariaLabelledBy="Title1">
			<f:toolbar>
				...
				<Label text="{i18nReuse>containerGroup}" required="true"/>
				<Input id="containerGroup" value="{/containerGroup}" >
				</Input>
				<Label text="{i18nReuse>container}" required="true"/>
