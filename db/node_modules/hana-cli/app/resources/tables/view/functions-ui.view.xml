<mvc:View controllerName="sap.hanacli.tables.controller.functions-ui" height="100%" width="100%"
	...
	<ScrollContainer height="100%" width="100%" vertical="true" focusable="true">
		<f:SimpleForm id="SimpleFormToolbar" editable="true" layout="ResponsiveGridLayout" adjustLabelSpan="true" singleContainerFullSize="false" ariaLabelledBy="Title1">
			<f:toolbar>
				...
				<Label text="{i18nReuse>function}" required="true"/>
				<Input id="Function" value="{/function}" showSuggestion="true" suggest="loadFunctionFilter">
				</Input>
