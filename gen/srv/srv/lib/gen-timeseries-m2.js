    ...
    async consumptionOfFO(aData, req) {
        ...
        if (aFilNegCIRData.length > 0) {
                ...
                for (let j = 0; j < liClusterResults.length; j++) {
                    ...
                    if (iReqQty > 0) {
                        ...
                        if (iReqQty >= aFilCIRData[0].CIR_QTY) {
                            iCIRQty = aFilCIRData[0].CIR_QTY;            // To be updated into CP_CIR_GENERATED table for UID
                            iReqQty = iReqQty - aFilCIRData[0].CIR_QTY;  // Remaining open qty
            ...
            if (aResCIR.length > 0) {
                ...
                await INSERT(aResCIR).into('CP_CIR_GENERATED');
