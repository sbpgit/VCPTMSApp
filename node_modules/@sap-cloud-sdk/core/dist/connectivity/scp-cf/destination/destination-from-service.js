...
var DestinationFromServiceRetriever = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        xsuaaCredentials = environment_accessor_1.getXsuaaServiceCredentials(options.userJwt);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, token_accessor_1.serviceToken('destination', __assign({}, options))];
                    case 1:
                        encoded = _c.sent();
                        _a = {};
                        _b = {};
                    ...
                    case 2: return [2 /*return*/, (_a.userJwt = (_b.decoded = _c.sent(),
                            ...
                            _b),
                            _a.serviceJwt = { encoded: encoded, decoded: jwt_1.decodeJwt(encoded) },
                            _a)];
                    case 3:
                        ...
                        return [4 /*yield*/, token_accessor_1.serviceToken('destination', __assign(__assign({}, options), { userJwt: payload }))];
                    case 4:
                        encoded = _c.sent();
                        clientCertJwt = { encoded: encoded, decoded: jwt_1.decodeJwt(encoded) };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, token_accessor_1.serviceToken('destination', __assign(__assign({}, optionsWithoutJwt), { xsuaaCredentials: xsuaaCredentials }))];
                    case 1:
                        encoded = _a.sent();
    ...
    DestinationFromServiceRetriever.prototype.getExchangeTenant = function (destination) {
        ...
        var subdomainSubscriber = xsuaa_service_1.getSubdomainAndZoneId((_b = (_a = this.subscriberToken) === null || _a === void 0 ? void 0 : _a.userJwt) === null || _b === void 0 ? void 0 : _b.encoded).subdomain;
        var subdomainProvider = xsuaa_service_1.getSubdomainAndZoneId((_c = this.providerServiceToken) === null || _c === void 0 ? void 0 : _c.encoded).subdomain;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, token_accessor_1.serviceToken('destination', {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        destination = destinationResult.destination, origin = destinationResult.origin;
                        if (!this.subscriberToken || !jwt_1.isUserToken(this.subscriberToken.userJwt)) {
                        ...
                        logger.debug("UserExchange flow started without user exchange token for destination " + this.name + " of the provider account.");
                        _a = {};
                        return [4 /*yield*/, token_accessor_1.jwtBearerToken(this.subscriberToken.userJwt.encoded, environment_accessor_1.getDestinationService(), this.options)];
                    ...
                    case 2:
                        ...
                        logger.debug("UserExchange flow started for destination " + this.name + " of the " + origin + " account.");
                        return [2 /*return*/, {
    ...
    DestinationFromServiceRetriever.prototype.addProxyConfiguration = function (destination) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (http_agent_1.proxyStrategy(destination)) {
                    case http_agent_1.ProxyStrategy.ON_PREMISE_PROXY:
                        return [2 /*return*/, connectivity_service_1.addProxyConfigurationOnPrem(destination, (_a = this.subscriberToken) === null || _a === void 0 ? void 0 : _a.userJwt)];
                    case http_agent_1.ProxyStrategy.INTERNET_PROXY:
                    case http_agent_1.ProxyStrategy.PRIVATELINK_PROXY:
                        return [2 /*return*/, http_agent_1.addProxyConfigurationInternet(destination)];
    ...
    DestinationFromServiceRetriever.prototype.isProviderAndSubscriberSameTenant = function () {
        return (this.subscriberToken &&
            tenant_1.isIdenticalTenant(this.subscriberToken.serviceJwt.decoded, this.providerServiceToken.decoded));
    };
