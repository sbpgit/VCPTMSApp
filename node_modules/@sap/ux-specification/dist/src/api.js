...
function importConfig(importParameters) {
    ...
    if (importParameters[page_1.FioriElementsVersion.v2]) {
        ...
        if (v2Params[schemaAccess_1.SchemaType.ListReport]) {
            config = import_1.createListReportConfig(v2Params[schemaAccess_1.SchemaType.ListReport]);
        }
        else if (v2Params[schemaAccess_1.SchemaType.ObjectPage]) {
            config = import_1.createObjectPageConfigV2(v2Params[schemaAccess_1.SchemaType.ObjectPage]);
        }
        else if (v2Params[schemaAccess_1.SchemaType.OverviewPage]) {
            config = import_1.createOverviewPageConfig(v2Params[schemaAccess_1.SchemaType.OverviewPage]);
        }
        else if (v2Params[schemaAccess_1.SchemaType.AnalyticalListPage]) {
            config = import_1.createAnalyticalListPageConfig(v2Params[schemaAccess_1.SchemaType.AnalyticalListPage]);
        }
    }
        ...
        if (v4Params[schemaAccess_1.SchemaType.ListReport]) {
            config = import_2.createListReportConfig(v4Params[schemaAccess_1.SchemaType.ListReport], schemaAccess_1.SchemaType.ListReport);
        }
        else if (v4Params[schemaAccess_1.SchemaType.ObjectPage]) {
            config = import_2.createObjectPageConfigV4(v4Params[schemaAccess_1.SchemaType.ObjectPage]);
        }
        else if (v4Params[schemaAccess_1.SchemaType.AnalyticalListPage]) {
            config = import_2.createListReportConfig(v4Params[schemaAccess_1.SchemaType.AnalyticalListPage], schemaAccess_1.SchemaType.AnalyticalListPage);
        }
    }
    return config;
}
