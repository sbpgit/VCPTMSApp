...
function importDateSettingsField(manifestSection, _sectionId, propertyKey) {
    const configPart = (manifestSection === null || manifestSection === void 0 ? void 0 : manifestSection[propertyKey]) ? JSON.parse(JSON.stringify(manifestSection === null || manifestSection === void 0 ? void 0 : manifestSection[propertyKey]))
        : undefined;
    let selectionField;
...
const manifestRuleForSelectionField = {
    path: (pageKeys, _manifest, breadcrumbs) => `${application_1.getAppSettingPathV2(pageKeys)}${common_1.DATESETTINGSPATH}/fields/${breadcrumbs}`
};
const manifestRuleForSelectionFieldWithArrays = Object.assign(Object.assign({}, manifestRuleForSelectionField), { import: importDateSettingsField, export: exportDateSettingsField });
