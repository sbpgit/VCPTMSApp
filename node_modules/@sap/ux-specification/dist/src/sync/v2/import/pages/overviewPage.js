    ...
    if (propertyKey === 'settings') {
        switch (manifestSection['template']) {
            case 'sap.ovp.cards.charts.analytical':
                configPart[pathHierarchy[0]][v2_1.CardSettingsType.analyticalCardSettings] = manifestSection[propertyKey];
                break;
            case 'sap.ovp.cards.v4.charts.analytical':
                configPart[pathHierarchy[0]][v2_1.CardSettingsType.analyticalCardSettingsv4] = manifestSection[propertyKey];
                break;
            case 'sap.ovp.cards.list':
            case 'sap.ovp.cards.v4.list':
                configPart[pathHierarchy[0]][v2_1.CardSettingsType.listCardSettings] = manifestSection[propertyKey];
                break;
            case 'sap.ovp.cards.stack':
                configPart[pathHierarchy[0]][v2_1.CardSettingsType.stackCardSettings] = manifestSection[propertyKey];
                break;
            case 'sap.ovp.cards.linklist':
            case 'sap.ovp.cards.v4.linklist':
                configPart[pathHierarchy[0]][v2_1.CardSettingsType.linkListCardSettings] = manifestSection[propertyKey];
                break;
            case 'sap.ovp.cards.table':
            case 'sap.ovp.cards.v4.table':
                configPart[pathHierarchy[0]][v2_1.CardSettingsType.tableCardSettings] = manifestSection[propertyKey];
                break;
            default:
        ...
        if (syncRule === null || syncRule === void 0 ? void 0 : syncRule.manifest) {
            ...
            if (Object.prototype.hasOwnProperty.call(manifestSection, propertyKey)) {
                if (pathHierarchy.length !== 0) {
                    ...
                    common_2.importProperty(syncRule, manifestSection, propertyKey, configPart);
                }
            }
        }
    }
 ...
 * @param OverviewPageConfig - the OVP configuration (JSON)
 * @param manifest  - manifest.json or app descriptor
 * @param appSchema - app specific JSON schema
 * @param factory - Metadata factory
 */
function addSettings(OverviewPageConfig, manifest, appSchema, factory) {
    transferSettingsOfObject(OverviewPageConfig, manifest, appSchema['properties'], []);
