...
function removeEmptySettings(config) {
    var _a, _b, _c, _d, _e;
    // Check ToolBar
    if ((_a = config.table) === null || _a === void 0 ? void 0 : _a.toolBar) {
    ...
    // Check FilterBar
    if ((_b = config.filterBar) === null || _b === void 0 ? void 0 : _b.selectionFields) {
        ...
        if (((_d = Object.keys((_c = config.filterBar) === null || _c === void 0 ? void 0 : _c.selectionFields)) === null || _d === void 0 ? void 0 : _d.length) === 0) {
            delete config.filterBar.selectionFields;
        }
    }
    // Check Footer
    if ((_e = config.footer) === null || _e === void 0 ? void 0 : _e.actions) {
