...
service CatalogService @(impl : './lib/cat-service.js') {
    ...
    action   postCIRQuantitiesToS4(LOCATION_ID : String(4), PLANNING_LOC : String, PRODUCT_ID : String(40), VERSION : String(10), SCENARIO : String(32), FROMDATE : Date, TODATE : Date, MODEL_VERSION : String(20), VALIDUSER : String(12), USER_ID : String(100));
