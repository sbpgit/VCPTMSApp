...
module.exports = async function () {
  ...
  let iSalesHistory = await dbConnect.dbQuery(
                            `SELECT * 
...
/*  osqlStmt =
    'SELECT DISTINCT "objectDependency" FROM V_BOMOBJ_DEP AS A WHERE EXISTS ( SELECT DISTINCT "locationID", "productId" FROM V_SALESH_CONFIG AS B WHERE A."locationId" = B."locationID" AND A."productId" = B."productId" )';

  let osqlStmt2 =
    'SELECT * FROM OBJDEP_HEADER WHERE "objectDependency" IN ( ' +
    osqlStmt +
    " )";
*/    
