...
module.exports = async function () {
     ...
     */
    async function getSalesInfo(imLocation) {
        let lLocation = "";
        let lProduct = "";
        let sSalesInfo = [];
        let iObjDep = [];
     ...
     *
     */
    async function processOrders(imLocation) {
        lsCount.ord = 0;
        let lCalDate = "";
     ...
     */
    async function processObjDepHead(sSalesInfo) {
    ...
    async function processObjDepChar(sSalesInfo) {
        let lCountInsert = 0;
 ...
 * Update Timeseries
 */
    async function updateTimeseries(lDate, lLocation) {
